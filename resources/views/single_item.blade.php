            ...
            <div class="row">
                <div class="col-sm-7 col-md-6">
                    <div class="slider border--round boxed--border" data-paging="true" data-arrows="true">
                        <ul class="slides">
                            <li><img alt="Image" src="https://images.craigslist.org/00S0S_1eXY0BUawnC_600x450.jpg">
                            </li>
                            <li><img alt="Image" src="https://images.craigslist.org/00q0q_9tS9oItGB3d_600x450.jpg">
                            </li>
                            <li><img alt="Image" src="https://images.craigslist.org/00d0d_6sU6C8gee70_600x450.jpg">
                            </li>
                            <li><img alt="Image" src="https://images.craigslist.org/00B0B_h5lZoeS1RbH_600x450.jpg">
                            </li>
                        </ul>
                    </div>
                    <!--end slider-->
                ...
                <div class="col-sm-5 col-md-4 col-md-offset-1">
                    ...
                    <div class="text-block">
                        ...
                        <span class="h4 inline-block">$479</span>
                    </div>
                    <p>
                        Tivoli's most popular line of consumer digital radios just got a refresh &mdash; expect clearer highs and deeper lows. Massive style upgrade with high-calibre aluminum frame and plush knobs and dials.
                    </p>
                    <ul class="accordion accordion-2 accordion--oneopen">
                        <li>
                            ...
                            <div class="accordion__content">
                                <ul class="bullets">
                                    <li>
                                        <span>Frequence Response: 25KHz &mdash; 24,000KHz</span>
                                    </li>
                                    <li>
                                        <span>DAB+ / FM / AM</span>
                                    </li>
                                    <li>
                                        <span>16,000 mAh Internal Rehcargable Battery</span>
                                    </li>
                                    <li>
                                        <span>10 Watts</span>
                                    </li>
                        ...
                        <li class="active">
                            ...
                            <div class="accordion__content">
                                <ul>
                                    <li>
                                        <span>Product: 3.5”W X 3.0”H X 3.0”D</span>
                                    </li>
                                    <li>
                                        <span>Packaging: 7”W X 6”H X 5”D </span>
                                    </li>
                                </ul>
                            </div>
                        </li>
                    ...
                    <form>
                        <div class="col-sm-12">
                            <div class="input-select">
                                <select name="finish">
                                    <option selected="" value="Default">Select A Finish</option>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="product">
                        <a href="#">
                            <img alt="Image" src="img/product-small-10.png" />
                        </a>
                        <a class="block" href="#">
                            <div>
                                <h5>DALI Xensor 2</h5>
